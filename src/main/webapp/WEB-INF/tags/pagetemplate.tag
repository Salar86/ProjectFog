    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="index.jsp">
                <img src="${pageContext.request.contextPath}/images/foglogo.png" class="img-fluid"/>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <c:if test="${sessionScope.user.role == 'user'}">
                        ...
                        <a class="nav-item nav-link" href="${pageContext.request.contextPath}/ordersForCustomer.jsp">Bestillingsstatus</a>
                    ...
                    <c:if test="${sessionScope.user != null }">
                        <a class="nav-item nav-link" href="${pageContext.request.contextPath}/logout">Log af</a>
                    </c:if>
                </div>
            </div>
        </div>
