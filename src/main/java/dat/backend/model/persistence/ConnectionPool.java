...
public class ConnectionPool
{
    ...
    private static String USER = "root"; //"dev";
    private static String PASSWORD = "meyer"; //"MeYer@5600";
    private static String URL = "jdbc:mysql://localhost:3306/project_fog"; //"jdbc:mysql://64.226.118.227:3306/project_fog";
